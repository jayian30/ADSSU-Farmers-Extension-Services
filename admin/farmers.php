...
<div class="content-header d-flex justify-content-between align-items-center mb-4">
    <div>
        <h2 class="h3 mb-0 text-gray-800">Farmers Management</h2>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-light border-0">
                <h5 class="modal-title" id="farmerModalLabel">Add New Farmer</h5>
...
function resetForm() {
    ...
    $('#farmer_id').val('');
    $('#action').val('add');
    $('#farmerModalLabel').text('Add New Farmer');
    $('#statusGroup').hide();
}
